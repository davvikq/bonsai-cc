...
def _watch_banner(project_root: Path) -> str:
    ...
    The "how to stop" instruction is intentionally NOT part of this
    string -- Q-to-quit was a TUI affordance the browser never had,
    and including it confuses users who try pressing Q in the page.
    The launching terminal still tells the user how to stop via the
    ``pipeline.py`` banner (Ctrl+C).
    """
